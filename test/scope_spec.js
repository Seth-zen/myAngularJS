...
describe('Scope', function() {
  ...
  describe('digest', function() {
    ...
    it('ends the digest when the last watch is clean', function() {
      ...
      scope.array = _.range(100); // array of 100 items on scope.
      var watchExecutions = 0;

      // Attach 100 watches, each watching a different single item
      // in array. watchExecutions++ to keep track of total number
      // of watch executiongs.
      ...
      // Run digest once, to initialize the watches. Durring this
      // each watch is run twice.
      scope.$digest();
      expect(watchExecutions).toBe(200);

      // Change first item in the array. The digets will short-
      // circuit on the first watch during second iteration and
      // end immediately, making the number of total watch 
      // executions just 301 and not 400.
      scope.array[0] = 420;
      scope.$digest();
    ...
    it('has a $$phase field whose value is the current digest phase', function() {
      ...
      scope.phaseInAppyFunction = undefined;
      ...
      scope.$apply(function(scope) {
        scope.phaseInAppyFunction = scope.$$phase;
      });
      expect(scope.phaseInWatchFunction).toBe('$digest');
      expect(scope.phaseInListenerFunction).toBe('$digest');
      expect(scope.phaseInAppyFunction).toBe('$apply');
  ...
  describe('$applyAsync', function() {
    ...
    it('coalesces many calls to $pplyAsync', function(done) {
  ...
  describe('$postDigest', function() {
    ...
    it('does not include $$ostDigest in the digest', function() {
  ...
  describe('inheritance', function() {
    ...
    it('can be nexted at any depth', function() {
    ...
    it('does not have access to parent atttributes when isolated', function() {
    ...
    it('shedules a digest from root on $evalAsync when isolated', function(done) {
  ...
  describe('$watchCollection', function() {
    ...
    it('notices an item replaced in an arugments object', function() {
